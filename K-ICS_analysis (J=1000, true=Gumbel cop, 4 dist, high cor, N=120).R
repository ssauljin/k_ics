...
c(prd120.var_std, prd120.var_emp, prd120.var_arc, prd120.var_elp) - pop.var_true
...
save.image("K-ICS_analysis (J=1000, true=Gumbel cop, 4 dist, high cor, N=120).RData")
