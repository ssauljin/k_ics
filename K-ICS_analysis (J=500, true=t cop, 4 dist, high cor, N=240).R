...
#### VaR estimation with sample size of 240 (one can replace 240 with any number, say, 120, 240, or 480)####
...
c(prd240.var_std, prd240.var_emp, prd240.var_arc, prd240.var_elp)
c(prd240.var_std, prd240.var_emp, prd240.var_arc, prd240.var_elp) - pop.var_true
