...
prd120_ggh  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=g cop, g dist, mid cor, N=120).RData")
prd120_ggm  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=g cop, g dist, low cor, N=120).RData")
prd120_ggl  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=Gumbel cop, 4 dist, high cor, N=120).RData")
prd120_a4h  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=Gumbel cop, 4 dist, mid cor, N=120).RData")
prd120_a4m  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=Gumbel cop, 4 dist, low cor, N=120).RData")
prd120_a4l  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=t cop, 4 dist, high cor, N=120).RData")
prd120_t4h  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=t cop, 4 dist, mid cor, N=120).RData")
prd120_t4m  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 

load("K-ICS_analysis (J=1000, true=t cop, 4 dist, low cor, N=120).RData")
prd120_t4l  <- cbind(prd120.vstd, prd120.vemp, prd120.varc, prd120.velp, pop.var_true) 
...
prt120_ggh     <- as.data.frame(cbind(as.vector(prd120_ggh[,1:4]-prd120_ggh[,5]),
                                     rep(1, 1000)))
prt120_ggh[,2] <- labels
